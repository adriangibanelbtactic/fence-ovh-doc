...
You can find an example of a cluster.conf based on three big server (Check bigserver explanation later) nodes depicted above here: [cluster_3_nodes.conf](../without-ipmi/cluster_3_nodes.conf) [(I recommend you to download it as raw file)] (https://github.com/adriangibanelbtactic/fence-ovh-doc/raw/without-ipmi/cluster_3_nodes.conf).
